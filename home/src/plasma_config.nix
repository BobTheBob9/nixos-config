{
  ...
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-363d2464-cc45-4f76-addd-1969602a4f4d" = [ ];
      ...
      "kwin"."MoveZoomUp" = [ ];
      "kwin"."Mudeer Center" = [ ];
      "kwin"."Mudeer Center Bottom" = [ ];
      "kwin"."Mudeer Center Left" = "Meta+X";
      "kwin"."Mudeer Center Left Bottom" = "Meta+Alt+X";
      "kwin"."Mudeer Center Left Top" = [ ];
      "kwin"."Mudeer Center Multi" = "Meta+Shift+S";
      "kwin"."Mudeer Center Multi Bottom" = "Meta+Alt+Shift+S";
      "kwin"."Mudeer Center Multi Top" = "Meta+Ctrl+Shift+S";
      "kwin"."Mudeer Center Right" = "Meta+C";
      "kwin"."Mudeer Center Right Bottom" = "Meta+Alt+C";
      "kwin"."Mudeer Center Right Top" = "Meta+Ctrl+C";
      "kwin"."Mudeer Center Top" = "Meta+Ctrl+S";
      "kwin"."Mudeer Far Bottom" = "Meta+Alt+Z";
      "kwin"."Mudeer Far Left" = "Meta+Z";
      "kwin"."Mudeer Far Left Top" = "Meta+Ctrl+Z";
      "kwin"."Mudeer Far Right" = [ ];
      "kwin"."Mudeer Far Right Bottom" = "Meta+Alt+V";
      "kwin"."Mudeer Far Right Top" = "Meta+Ctrl+V";
      "kwin"."Mudeer Fullscreen Left" = [ ];
      "kwin"."Mudeer Fullscreen Left Remainder" = [ ];
      "kwin"."Mudeer Fullscreen Prefix" = "Meta+Ctrl+F";
      "kwin"."Mudeer Fullscreen Prefix Avoid Panel" = "Meta+Ctrl+Shift+F";
      "kwin"."Mudeer Fullscreen Right" = [ ];
      "kwin"."Mudeer Fullscreen Right Remainder" = [ ];
      "kwin"."Mudeer Half Left" = "Meta+Shift+Z";
      "kwin"."Mudeer Half Left Bottom" = "Meta+Alt+Shift+Z";
      "kwin"."Mudeer Half Left Top" = "Meta+Ctrl+Shift+Z";
      "kwin"."Mudeer Half Right" = "Meta+Shift+V";
      "kwin"."Mudeer Half Right Bottom" = "Meta+Alt+Shift+V";
      "kwin"."Mudeer Half Right Top" = "Meta+Ctrl+Shift+V";
      "kwin"."Mudeer Left" = "Meta+A";
      "kwin"."Mudeer Left Bottom" = "Meta+Alt+A";
      "kwin"."Mudeer Left Multi" = "Meta+Shift+A";
      "kwin"."Mudeer Left Multi Bottom" = "Meta+Alt+Shift+A";
      "kwin"."Mudeer Left Multi Top" = "Meta+Ctrl+Shift+A";
      "kwin"."Mudeer Left Top" = [ ];
      "kwin"."Mudeer Right" = "Meta+D";
      "kwin"."Mudeer Right Bottom" = "Meta+Alt+D";
      "kwin"."Mudeer Right Multi" = "Meta+Shift+D";
      "kwin"."Mudeer Right Multi Bottom" = "Meta+Alt+Shift+D";
      "kwin"."Mudeer Right Multi Top" = "Meta+Ctrl+Shift+D";
      "kwin"."Mudeer Right Top" = "Meta+Ctrl+D";
      "kwin"."Mudeer Three-Quarters Left" = "Meta+Shift+X";
      "kwin"."Mudeer Three-Quarters Left Bottom" = "Meta+Alt+Shift+X";
      "kwin"."Mudeer Three-Quarters Left Top" = "Meta+Ctrl+Shift+X";
      "kwin"."Mudeer Three-Quarters Right" = "Meta+Shift+C";
      "kwin"."Mudeer Three-Quarters Right Bottom" = "Meta+Alt+Shift+C";
      "kwin"."Mudeer Three-Quarters Right Top" = "Meta+Ctrl+Shift+C";
    ...
    files = {
      ...
      "kactivitymanagerdrc"."activities"."363d2464-cc45-4f76-addd-1969602a4f4d" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "363d2464-cc45-4f76-addd-1969602a4f4d";
      "kcminputrc"."Libinput.5426.80.Razer Razer Naga Hex V2"."PointerAccelerationProfile" = 1;
      ...
      "kglobalshortcutsrc"."org.flameshot.Flameshot.desktop"."_k_friendly_name" = "Flameshot";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{23ed2d5b-f1c0-471e-bd24-4351866636e2}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{696a878e-2871-43c3-977e-2a3e52fb78e8}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{d2fd47a9-aa75-452a-bfdb-c292baf82bda}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{f4cdba08-4b25-4584-90e5-c8c9b2bfba74}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{93aaf055-1ac9-4ef7-a6dd-8f074a62fc37}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{a083b3c9-264d-492e-af93-7c5625fb42e7}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{5763b721-8de9-47d9-ac58-e1fa8f626ea5}";
      ...
      "kwinrc"."Desktops"."Id_1" = "4bcf5fac-919d-4072-a591-07ca9b5b6009";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."NightColor"."Mode" = "Constant";
      "kwinrc"."Plugins"."mudeer-ultrawideEnabled" = false;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling.0538f32a-30ed-5d5f-8f31-cf3bdef720b6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling.7fc64f78-3778-56af-bbe9-10d40edcd6b9"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling.9ac8094c-b9e7-55df-adc4-3a9e25fdeffd"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.9c45c7ae-01d7-542d-adf0-6552eb05840a"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.ca9de812-a7be-50b3-a5a5-51ac42ec36c6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.d7411446-9ead-5a0e-bfb0-0c503a937ca2"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.dc8a429a-3ed8-59c7-afe5-afa88380c5fc"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.f619d4f5-d883-579f-9756-b23293d313b3"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
